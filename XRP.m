...
(*n = 8; *)
(*Clear[F2]*)
(*sol2 = NDSolve[{Derivative[1][F2][s] == (Beta[n, n]*BetaRegularized[1 - F2[s], n, n])/(((1 - F2[s])^(n - 1)*F2[s]^(n - 1))*(s - Evaluate[InvG[F2[s]]])), F2[641/210] == 0.999999999}, F2, {s, 29/30, 641/210}, WorkingPrecision -> 40,Method-> "StiffnessSwitching",AccuracyGoal->20,MaxSteps->\[Infinity]]*)
...
(*Plot3D[{s[c,e],scr[s[c,e]]},{c,10,100},{e,-5,5},AxesLabel->{"Cost","Noise","Score"},Exclusions->None,PlotRange-> {{10,100},{-45,45}},Ticks-> {{10,55,100},{-5,0,5},{1,2,3}}]*)
(*Plot3D[{c,b[c,e]},{c,10,100},{e,-5,5},AxesLabel->{"Cost","Noise","Bid"},Exclusions->None,PlotRange-> {{10,100},{-45,45}},Ticks-> {{10,55,100},{-5,0,5},{10,55,100}}]*)
